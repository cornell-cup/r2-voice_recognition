...
Cornell Cup Robotics, 2018-2019
...
# thread consistently sending data to R2 for voice-based movement
...
# turns speech into text that can be easily parsed for intent
